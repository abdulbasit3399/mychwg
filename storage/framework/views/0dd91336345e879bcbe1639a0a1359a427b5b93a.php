            ...
            <div class="modal-content">
                ...
                <div class="d-flex align-items-center pt-1 border-bottom pb-1">
                    ...
                    <div class="user-img">
                        ...
                        <img src="<?php echo e(asset(Auth::user()->avatar)); ?>" alt="<?php echo e(Auth::user()->name); ?>" class="profile-avatar-small1 ml-2">
                ...
                <form id="post-form" action="<?php echo e(route('social.save.post')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body create-post-model-contents">
                        ...
                        <ul class="d-flex flex-wrap align-items-center shadow-lg list-inline m-0 p-0 rounded">
                            ...
                            <li class="col-md-6">
                                ...
                                <a id="OpenImgUpload" data-toggle="tooltip" data-placement="bottom" title="Photo/Video"><div class="iq-bg-primary rounded p-2 pointer mr-3"><img src="<?php echo e(asset('admin/multimedia-icon.png')); ?>" alt="icon" class="img-fluid"> Photo/Video</div>
...
<div class="modal fade" id="modalUpdateAvatar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-zoom" role="document">
    ...
    <div class="modal-content">
      ...
      <form id="cover-form" method="POST" action="<?php echo e(route('social.cover.update')); ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="modalCreateGroup" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
      ...
      <form action="<?php echo e(route('social.group.create')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="carousel-inner rounded">
                      ...
                      <?php $__currentLoopData = adsSponsorship(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="carousel-item <?php if($loop->first): ?> active <?php endif; ?>">
                            ...
                            <img class="d-block slider-img-show w-100" src="<?php echo e(asset($item->image)); ?>" alt="First slide">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <a href="<?php echo e(route('advocate.events.create')); ?>" class="btn btn-primary">Click Here</a>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom " role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="<?php echo e(route('social.create.new.album')); ?>" method="post" id="createNewAlbumForm">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom " role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="<?php echo e(route('social.create.new.album')); ?>" method="post" id="uploadPhotoInAlbumForm">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 mb-3">
                    ...
                    <div class="card m-auto">
                        ...
                        <div class="image_div">
                            ...
                            <img src="<?php echo e(asset('front/post.png')); ?>">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 mb-3">
                    ...
                    <div class="card m-auto">
                        ...
                        <div class="image_div">
                            ...
                            <img src="<?php echo e(asset('front/resource.png')); ?>">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom shodow-0">
      ...
      <div class="modal-content rounded-0 shodow-0">
        ...
        <div class="modal-body">
            ...
            <form action="<?php echo e(route('social.save.post')); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom shodow-0">
      ...
      <div class="modal-content rounded-0 shodow-0">
        ...
        <div class="modal-body">
            ...
            <form action="<?php echo e(route('social.save.category.post')); ?>" method="post">
                ...
                <?php $__currentLoopData = Auth::user()->folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <input type="radio" name="user_folder_id" required value="<?php echo e($item->id); ?>" id="<?php echo e($item->id); ?>"> <label class="font-weight-bold" for="<?php echo e($item->id); ?>"><?php echo e($item->title); ?></label><hr>
