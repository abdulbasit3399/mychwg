...
<section style="background:#F9F9F9;" class="py-5 subscription_page">
    <div class="container py-3 bg-white">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-sm-12 mt-4 px-5">
                <div class="clearfix">
                ...
                <?php else: ?>
                    ...
                    <h5 class="font-weight-bold">Advocacy Program (Social Platform)</h5>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mychwg\resources\views/front/subscription/expire.blade.php ENDPATH**/ ?>