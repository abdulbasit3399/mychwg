...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin/css/pages/authentication.css')); ?>">
...
<body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page bg-dark" data-open="click" data-menu="vertical-menu-modern" data-col="1-column" style="background : url(<?php echo e(asset('admin/images/pages/vuexy-login-bg.jpg')); ?>) no-repeat center center;">
                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <div class="card-header pb-1">
                                            ...
                                            <div class="card-title">
                                                ...
                                                <h4 class="mb-0">Hello <?php echo e(env('APP_NAME')); ?> Team</h4>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="card-body pt-1 mb-3">
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.attempt.login')); ?>">

                                                    <?php echo csrf_field(); ?>

                                                <fieldset class="form-label-group form-group position-relative has-icon-left">

                                                        <input id="email" type="email" name="email"  for="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus class="form-control"  placeholder="Email" required>
    ...
    <script src="<?php echo e(asset('admin/js/scripts/pages/dashboard-analytics.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\mychwg\resources\views/admin/login.blade.php ENDPATH**/ ?>