...
<header>
    <div class="wrapper">
        <div id="header_content" style="background:#dcf2fa url('{{ asset($setting['inner_page_banner_image'] ?? '')  }}') no-repeat 50% center;background-size: cover;">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{ route('login') }}">
                            ...
                            <div class="form-group has-feedback">
                                <input name="email" id="email" tabindex="1" class="form-control" placeholder="Email address*" type="email" required="" value="{{old('email')}}">
