<div class="card profile_navs">
    ...
    <div class="tab-content" id="nav-tabContent">
            ...
            <div class="row card-body">
                ...
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" readonly value="{{ $user->userSocialProfile->location ?? '' }}">
                ...
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" readonly value="{{ Auth::user()->userSocialProfile->caption ?? '' }}">
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea type="text" rows="7" class="form-control" readonly>{{ $user->userSocialProfile->about ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" readonly value="{{ $user->userSocialProfile->website ?? '' }}">
                        </div>
                    </div>
                </div>
      ...
      <div class="tab-pane fade " id="nav-groups" role="tabpanel" aria-labelledby="nav-groups-tab">
        <div class="row">
            @forelse($user->userSocialGroups as $group)
