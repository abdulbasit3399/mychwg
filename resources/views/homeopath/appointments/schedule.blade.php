                                        ...
                                        @if(isset($day_time_table))
                                            ...
                                            @foreach($day_time_table->daySlots as $slot)
                                                    ...
                                                    @endif
                                                        ...
                                                        {{ \Carbon\Carbon::parse($slot->from)->format('h:i a') }} - {{ \Carbon\Carbon::parse($slot->to)->subMinutes(15)->format('h:i a') }}<br>
                        ...
                        <td>
                            ...
                            <select class="w-100 slot_from" name="from[]" required="">
                                ...
                                @for($i = 1; $i < 24; $i++)
                                    ...
                                    <option value="{{ $i < 10 ? '0' : '' }}{{ $i }}:15">{{ $i < 10 ? '0' : '' }}{{ $i }}:15</option>

                                    <option value="{{ $i < 10 ? '0' : '' }}{{ $i }}:30">{{ $i < 10 ? '0' : '' }}{{ $i }}:30</option>

                                    <option value="{{ $i < 10 ? '0' : '' }}{{ $i }}:45">{{ $i < 10 ? '0' : '' }}{{ $i }}:45</option>
