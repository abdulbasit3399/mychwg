<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow homeopath-sidebar myclinic" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href="{{ route('social.index') }}"><i class=""></i><img src="{{asset('uploads/img/mflogo.png')}}" width="137"></a></li>
            ...
            <li class="nav-item has-sub">
                ...
                <a href="#" class="font-weight-bold"><i class=""></i><img src="{{asset('uploads/img/16.png')}}" width="150">
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="@routeis('homeopath.link.account') active @endrouteis"><a href="{{ route('homeopath.link.account') }}"><i class="fas fa-money"></i>Link Account</a></li>
