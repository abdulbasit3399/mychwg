...
<section class="content">
    <div id="custom_single_page">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
            <div class="row img-part">
                <div class="col-md-12 col-sm-12 colxs-12 img-section">
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="17 38.8 166.1 122.7" viewBox="17 38.8 166.1 122.7" height="150" width="150" xmlns="http://www.w3.org/2000/svg" data-type="color" role="img" aria-labelledby="svgcid-gvyzjwad96l4"><defs><style>#comp-koueceuz svg [data-color="1"] {fill: #C4E4C9;}</style></defs><title id="svgcid-gvyzjwad96l4"></title>
                        <g>
                        <path d="M130.2 69.6c-.7.9-.7 2.5.2 3.1l30.7 24c.4.4.9.4 1.4.4.7 0 1.4-.2 1.9-.9.7-.9.7-2.5-.2-3.1l-30.7-23.9c-1-.6-2.7-.6-3.3.4z" fill="#C4E4C9" data-color="1"></path>
                    <path d="M151.8 101.7c.7 0 1.4-.2 1.9-.9.7-.9.7-2.5-.2-3.1l-18-14.1c-.9-.6-2.6-.6-3.2.2s-.7 2.5.2 3.1l18 14.1c.1.5.9.7 1.3.7z" fill="#C4E4C9" data-color="1"></path>
                <path d="M116.4 54.2l6.8-6.7c.7-.6 1.9-.9 2.8 0l41.4 32.3c.4.4.9.4 1.4.4.7 0 1.4-.2 1.9-.9.7-.9.7-2.5-.2-3.1l-32.9-25.4 3.4-4c2.1-2.7 5.3-4 8.9-4 2.6 0 4.9.6 6.8 2.3l12.5 9.4c2.3 1.8 3.4 4.5 3.4 7.2 0 2-.7 4-1.9 5.6-.7 1.1-.4 2.5.4 3.1.4.2.9.4 1.4.4.7 0 1.4-.2 1.9-.9 1.9-2.5 2.8-5.2 2.8-8.1 0-4.3-1.9-8.1-5.6-10.8l-12.1-9.1c-2.8-2-6.1-3.1-9.5-3.1-4.9 0-9.5 2.3-12.3 5.8l-3.4 4-4.9-3.8c-2.6-2.3-6.8-2.3-9.3.2l-6.8 6.7c-.9.9-.9 2.3 0 3.1.8.7 2.2.3 3.1-.6z" fill="#C4E4C9" data-color="1"></path>
            <path d="M71.9 100.3c.9.4 1.9.6 3 .6.4 0 .9 0 1.4-.2l22.9-5.8c1.9-.2 3.2-1.8 3.2-3.6 0-.9-.4-1.8-.9-2.5l-7.9-9.4c-.2-.2-.2-.6-.2-.9 0-.4.2-1.1.7-1.6L108.5 62c.9-.9.9-2.3 0-3.1s-2.3-.9-3.2 0L90.6 74.2c-1.4 1.1-2.1 2.9-2.1 4.7 0 1.1.2 2.5.9 3.3 0 0 0 .2.2.2l7.2 8.7-21.6 5.6c-.4 0-.9 0-1.4-.2-1.1-.4-2.6 0-3 1.1-.5.9 0 2.3 1.1 2.7z" fill="#C4E4C9" data-color="1"></path>
        <path d="M112.9 109c-1.4-1.3-3.2-2-5.1-2h-.7l-29.8 1.8c-2.1.2-4 1.1-5.1 2.7l-6.5 8.3c-.9 1.1-2.1 1.8-3.4 2l-2.1.2c-.2 0-.4-.2-.4-.4l-4.2-28.4c0-.2.2-.4.4-.4l2.1-.2c1.4-.2 2.8.2 4.2 1.1.9.6 2.3.4 3.2-.4.7-.9.4-2.5-.4-3.1-2.1-1.6-4.9-2.3-7.4-1.8l-2.1.2c-2.6.4-4.4 2.5-4.4 5v.6l4.2 28.2c.4 2.7 3 4.7 5.8 4.3l1.9-.2c2.6-.4 4.9-1.6 6.5-3.6l6.5-8.3c.4-.4 1.1-.9 1.7-.9l29.8-1.8c.7 0 1.4.2 1.9.6l17.2 19.5c.4.4 1.1.6 1.9.6.4 0 1.1-.2 1.4-.4.9-.9 1.1-2.3.2-3.1L112.9 109z" fill="#C4E4C9" data-color="1"></path>
    <path d="M180.4 84.4l-1.1-.9c-.9-.6-2.6-.6-3.2.2-.7.9-.7 2.5.2 3.1l1.1.9c.4.4.7.9.7 1.3s-.2.9-.7 1.3l-14.2 15-4.4-3.6c-.9-.6-2.6-.6-3.2.2-.7.9-.7 2.5.2 3.1l4.2 3.3-23.1 24.4-.4.4c-1.1.6-1.7 2-.9 2.9.4.6 1.1 1.1 2.1 1.1.4 0 .7 0 1.1-.2.7-.2 1.1-.6 1.9-1.3l40.5-42.5c1.1-1.1 1.9-2.7 1.9-4.5-.5-1.3-1.2-2.8-2.7-4.2z" fill="#C4E4C9" data-color="1"></path>
<path d="M47.5 122.3h1.1c1.1-.2 2.1-1.3 2.1-2.5-.2-1.1-1.4-2-2.6-2l-1.1.2c-1.1.2-2.3.6-3.4 1.3-1.4.9-2.1 2.9-2.1 5.8 0 1.1 0 2.3.2 3.3.2 2 .9 4.5 2.1 7.2.4.9 1.1 1.3 2.1 1.3.2 0 .4 0 .9-.2 1.1-.4 1.9-1.8 1.4-2.9-.9-2.3-1.7-4.5-1.9-6-.2-.9-.2-2-.2-2.7 0-1.3.2-2.3.2-2.5.5-.1.8-.1 1.2-.3z" fill="#C4E4C9" data-color="1"></path>
<path d="M53.1 143.6c-.7-1.1-2.1-1.3-3.2-.6-1.1.6-1.4 2-.7 3.1.4.6.7 1.1.9 1.6.4.6 1.1.9 1.9.9.4 0 .9-.2 1.4-.4 1.1-.6 1.4-2 .7-3.1-.4-.4-.6-.8-1-1.5z" fill="#C4E4C9" data-color="1"></path>
<path d="M26.8 107.8c.7 0 1.1-.2 1.7-.6.9-1.1 2.1-2 3.2-2.7 3.4-2.5 7.4-4 11.7-4.7 1.1-.2 2.1-1.3 1.9-2.5-.2-1.1-1.4-2-2.6-1.8-4.9.6-9.5 2.7-13.5 5.6-1.4.9-2.8 2-4 3.3-.9.9-.7 2.3.2 3.1.3 0 .9.3 1.4.3z" fill="#C4E4C9" data-color="1"></path>
<path d="M22.6 132.4c0-.4-.2-.9-.2-1.3-.2-2-.4-4-.4-5.8 0-3.3.4-6.5 1.4-9.4.4-1.1-.2-2.5-1.7-2.7-1.1-.4-2.6.2-3 1.6-1.1 3.3-1.7 6.9-1.7 10.8 0 2 .2 4.3.4 6.5 0 .4.2 1.1.2 1.6.2 1.1 1.1 1.8 2.3 1.8h.4c1.6-.7 2.5-2 2.3-3.1z" fill="#C4E4C9" data-color="1"></path>
<path d="M25.7 142.6c-.4-1.1-1.9-1.8-3-1.3-1.1.4-1.9 1.8-1.4 2.9 3.4 8.3 7.9 15 8.9 16.4.4.6 1.1.9 1.9.9.4 0 .9-.2 1.4-.4 1.1-.6 1.4-2 .7-3.1-.7-.8-5.3-7.3-8.5-15.4z" fill="#C4E4C9" data-color="1"></path>
<path d="M38.9 113.6c.4-.4.9-.6 1.4-.9 1.1-.6 1.4-2 .9-3.1-.7-1.1-2.1-1.3-3.2-.9-.7.4-1.4.9-1.9 1.3-4.7 3.3-6.8 8.3-6.8 15.2v.6c0 1.1 1.1 2.3 2.3 2.3 1.4 0 2.3-1.1 2.3-2.3v-.6c.1-5.4 1.7-9.2 5-11.6z" fill="#C4E4C9" data-color="1"></path>
<path d="M36.1 136.2c-.4-1.1-1.7-1.8-3-1.3-1.1.4-1.9 1.6-1.4 2.9 3 8.7 8.4 16.1 8.7 16.6.4.6 1.1.9 1.9.9.4 0 .9-.2 1.4-.4 1.1-.6 1.4-2 .7-3.1-.4-.4-5.5-7.5-8.3-15.6z" fill="#C4E4C9" data-color="1"></path>
</g>
</svg>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
...
<div class="row img-part">
<div class="col-md-12 col-sm-12 colxs-12 img-section">
<svg preserveAspectRatio="xMidYMid meet" data-bbox="10 10 180 180" viewBox="10 10 180 180"  height="120" width="120"  xmlns="http://www.w3.org/2000/svg" data-type="color" role="img" aria-labelledby="svgcid--kkuyl5tlxwr"><defs><style>#comp-koueeho8 svg [data-color="1"] {fill: #EFA26E;}</style></defs><title id="svgcid--kkuyl5tlxwr"></title>
<g>
<path d="M91.4 51.9c-9.7 1.7-18.4 7.6-25.1 13H81c2.8-2.7 6.3-9.3 10.4-13z" fill="#EFA26E" data-color="1"></path>
<path d="M78 70.3H61.4c-5.7 9-9.2 16.2-9.5 27h19.9c.1-10.8 2.4-18 6.2-27z" fill="#EFA26E" data-color="1"></path>
<path d="M71.7 101.8H51.9c.6 9.9 3.5 16.2 7.9 23.4H77c-3-7.2-4.8-13.5-5.3-23.4z" fill="#EFA26E" data-color="1"></path>
<path d="M116.5 125.2c3.3-7.2 5.4-13.5 5.8-23.4h-45c.4 9.9 2.5 16.2 5.8 23.4h33.4z" fill="#EFA26E" data-color="1"></path>
<path d="M133.4 64.9c-6.8-5.4-15.5-11.2-25.1-13 4.1 3.8 7.6 10.3 10.4 13h14.7z" fill="#EFA26E" data-color="1"></path>
<path d="M115.4 70.3H84.2c-4.2 9-6.7 16.2-6.9 27h45.1c-.3-10.8-2.8-18-7-27z" fill="#EFA26E" data-color="1"></path>
<path d="M112.1 64.9c-3.4-5.4-7.6-9.4-12.3-12.8-4.7 3.4-8.9 7.4-12.2 12.8h24.5z" fill="#EFA26E" data-color="1"></path>
<path d="M127.9 97.3h19.9c-.4-10.8-3.9-18-9.5-27h-16.7c3.8 9 6 16.2 6.3 27z" fill="#EFA26E" data-color="1"></path>
<path d="M100 10c-49.7 0-90 40.2-90 90 0 49.7 40.3 90 90 90s90-40.3 90-90c0-49.8-40.2-90-90-90zm-.2 142.5c-29.5 0-53.5-24-53.5-53.6s24-53.5 53.5-53.5 53.5 24 53.5 53.5-24.1 53.6-53.5 53.6z" fill="#EFA26E" data-color="1"></path>
<path d="M79.8 130.6H64.3c7 8.1 16.4 13.1 27.1 15-4.7-4.3-8.6-10.5-11.6-15z" fill="#EFA26E" data-color="1"></path>
<path d="M122.5 125.2h17.2c4.5-7.2 7.3-13.5 7.9-23.4h-19.8c-.4 9.9-2.2 16.2-5.3 23.4z" fill="#EFA26E" data-color="1"></path>
<path d="M86.1 130.6c3.6 7.2 8.2 11 13.7 14.9 5.4-4 10-7.6 13.7-14.9H86.1z" fill="#EFA26E" data-color="1"></path>
<path d="M108.3 145.6c10.6-1.9 20.1-6.9 27.1-15h-15.5c-3.2 4.5-7 10.7-11.6 15z" fill="#EFA26E" data-color="1"></path>
</g>
</svg>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
...
<div class="row img-part">
<div class="col-md-12 col-sm-12 colxs-12 img-section">
<svg preserveAspectRatio="xMidYMid meet" data-bbox="45 30.967 110 138.037" viewBox="45 30.967 110 138.037" height="110" width="110" xmlns="http://www.w3.org/2000/svg" data-type="color" role="img"><defs><style>#comp-koueendj svg [data-color="1"] {fill: #129A8C;}</style></defs>
<g>
<path d="M116.9 41.2c.6-.1 1.1-.2 1.7-.3l-15.8-9.4c-1.5-.8-3.4-.7-4.8.3L69.1 53.9l47.8-12.7z" fill="#129A8C" data-color="1"></path>
<path d="M129.5 63l16.5 8.6v-6.1c0-2.3-1.2-4.5-3.3-5.7l-19.2-11.4c-1.1-.6-3.2-1.3-4.4-1L59.7 62.3c-2.5.7-4.2 2.9-4.2 5.5v8.1L121.4 62c2.7-.8 5.6-.4 8.1 1z" fill="#129A8C" data-color="1"></path>
<path d="M155 86.4c0-2.3-1.3-4.5-3.4-5.6L126.8 68h-.1c-1.2-.7-2.6-.9-3.9-.5L50.7 82.6c-.1 0-.2 0-.3.1-3.2.8-5.4 3.6-5.4 6.8v75c0 2.5 2.1 4.6 4.6 4.5l70.9-.3c.5 0 .9-.4.9-.9V78.6c0-1.5 1.2-2.9 2.8-2.9 1.6 0 2.9 1.2 2.9 2.8v89.4c0 .5.4.8.8.8l21.6-.2c3 0 5.5-2.5 5.5-5.4V86.4zm-96.4 38.2c0 1.3-1.1 2.4-2.4 2.4-1.3 0-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4 1.3 0 2.4 1.1 2.4 2.4v8zm0-20.8c0 1.3-1.1 2.4-2.4 2.4-1.3 0-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4 1.3 0 2.4 1.1 2.4 2.4v8zm13.2 17.5c0 1.3-1.1 2.4-2.4 2.4-1.3 0-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4 1.3 0 2.4 1.1 2.4 2.4v8zm0-20.7c0 1.3-1.1 2.4-2.4 2.4-1.3 0-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4 1.3 0 2.4 1.1 2.4 2.4v8zM85 118.4c0 1.3-1.1 2.4-2.4 2.4-1.3 0-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4 1.3 0 2.4 1.1 2.4 2.4v8zm0-20.7c0 1.3-1.1 2.4-2.4 2.4-1.3 0-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4 1.3 0 2.4 1.1 2.4 2.4v8zm13.8 17.9c0 1.3-1.1 2.4-2.4 2.4s-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4s2.4 1.1 2.4 2.4v8zm0-20.7c0 1.3-1.1 2.4-2.4 2.4S94 96.2 94 94.9v-8c0-1.3 1.1-2.4 2.4-2.4s2.4 1.1 2.4 2.4v8zm13.8 17.4c0 1.3-1.1 2.4-2.4 2.4s-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4s2.4 1.1 2.4 2.4v8zm0-20.7c0 1.3-1.1 2.4-2.4 2.4s-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4s2.4 1.1 2.4 2.4v8zm26 21.2c0 1.3-1.1 2.4-2.4 2.4-1.3 0-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4 1.3 0 2.4 1.1 2.4 2.4v8zm0-20.2c0 1.3-1.1 2.4-2.4 2.4-1.3 0-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4 1.3 0 2.4 1.1 2.4 2.4v8zm11.4 24.9c0 1.3-1.1 2.4-2.4 2.4s-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4s2.4 1.1 2.4 2.4v8zm0-20.2c0 1.3-1.1 2.4-2.4 2.4s-2.4-1.1-2.4-2.4v-8c0-1.3 1.1-2.4 2.4-2.4s2.4 1.1 2.4 2.4v8z" fill="#129A8C" data-color="1"></path>
</g>
</svg>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
