<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto mt-0"><a class="navbar-brand mt-0" style="padding-top: 10px;border: none;" href="{{ route('index') }}">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @can('browse_settings')
                ...
                <li class="nav-item @routeis('newsletter.email.list')  @endrouteis"><a href="{{ route('newsletter.email.list')}}"><i class="feather icon-mail"></i>Newsletter Management</a></li>
            @endcan
            ...
            @can('browse_finance')
                ...
                <li class="nav-item @routeis('admin.subscriptions.index') active @endrouteis"><a href="{{ route('admin.subscriptions.index') }}"><i class="feather icon-users"></i>Subscriptions</a></li>
