...
Route::namespace('Front')->middleware('visitlog')->group(function () {
    ...
    Route::get('homeopathy/practitioners', 'FrontEndController@homeopathyPractitioners')->name('homeopathy.practitioners');
    Route::get('explore-homeopathy-detail', 'FrontEndController@exploreHomeopathyDetail')->name('explore.homeopathy.detail');
...
Route::middleware(['auth', 'status'])->group(function () {
    ...
    Route::name('social.')->prefix('social-network')->namespace('Social')->middleware(['auth', 'status', 'subscribed'])->group(function () {
        ...
        Route::post('/create/category/folder', 'SavedPostController@createCategoryFolder')->name('create.category.folder');
        Route::post('/save/category/post', 'SavedPostController@saveCategoryPost')->name('save.category.post');
        Route::get('/category/posts/{id}', 'SavedPostController@getSavedPosts')->name('category.posts');
        ...
        Route::get('/group/request/{action}/{post_id}/', 'SocialNetworkPageController@groupRequestActionPost')->name('group.request.action.post');
        Route::get('/share/resource/{id?}', 'SocialNetworkPageController@shareResource')->name('share.resource');
...
Route::name('user.')->prefix('user')->namespace('User')->middleware(['status', 'user'])->group(function () {
...
Route::name('homeopath.')->prefix('homeopath')->namespace('Homeopath')->middleware(['status', 'homeopath', 'subscribed'])->group(function () {
    ...
    Route::middleware('homeopath.profile.active')->group(function () {
        ...
        Route::get('/link/account', 'AccountController@linkAccount')->name('link.account');
        ...
        Route::name('settings.')->prefix('settings')->group(function () {
            ...
            Route::post('/update/additional/documents', 'SettingsController@updateAdditionalDocuments')->name('update.additional.documents');
            Route::get('/service/document/remove', 'SettingsController@serviceDocumentRemove')->name('service.document.remove');
        });
...
Route::name('advocate.')->prefix('advocate')->namespace('Advocate')->middleware(['status', 'advocate', 'subscribed'])->group(function () {
...
Route::post('admin/login', 'Admin\AdminLoginController@AdminAttemptLogin')->name('admin.attempt.login');
    ...
    Route::get('transfer/amount/{id}', 'PaymentController@transferAmount')->name('transfer.amount');
    ...
    Route::name('setting.')->prefix('settings')->group(function () {
        ...
        Route::view('/homeopath/practitioners', 'admin.setting.pages.homeopath_practitioners')->name('practitioners');
